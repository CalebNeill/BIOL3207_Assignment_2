...
```{r}
escalctest <- escalc(measure = "ROM", n1i = ctrl.n, n2i = oa.n, m1i = ctrl.mean, m2i = oa.mean, sd1i = ctrl.sd, sd2i = oa.sd, data = dftest)

dftest <- cbind(dftest, yi = escalctest$yi, vi = escalctest$vi)
dftest
```
