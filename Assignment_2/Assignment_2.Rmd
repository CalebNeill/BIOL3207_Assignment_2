...
```{r}
corr_val <- cor(datafinal$ctrl.mean, datafinal$oa.mean)
corr_val

datafinal %>% ggplot(mapping = aes(x = ctrl.mean, y = oa.mean)) +
  geom_point()
```

```{r}
zr_data <- escalc(meaure = "ROMC", n1i = ctrl.n, n2i = oa.n, m1i = ctrl.mean, m2i = oa.mean, sd1i = ctrl.sd, sd2i = oa.sd, ri = )
